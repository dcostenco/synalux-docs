...
## 🏥 Підтримувані типи практики

Synalux — це **мультипрактична корпоративна платформа**, яка підтримує 6 медичних спеціальностей з коробки. Кожен тип практики включає спеціалізовані клінічні шаблони, коди рахунків, тарифні сітки та робочі процеси.
