...
**منصة السجل الصحي الإلكتروني المعيارية — أصلية بالذكاء الاصطناعي، متوافقة مع HIPAA، محايدة التخصص**

> Synalux هي منصة سجل صحي إلكتروني مفتوحة وقابلة للتعديل تكيّف لغتها السريرية ونماذج بياناتها وسلوك الذكاء الاصطناعي لأي تخصص طبي.
...
* **🛡️ صندوق رمل الذكاء الاصطناعي — "الطبيب في الحلقة" :** Synalux هو أول سجل صحي إلكتروني حيث **لا يستطيع الذكاء الاصطناعي لمس بياناتك بدون توقيعك**.
* **🔐 RLS بدون حالة — تحجيم أفقي بدون حمل جلسات.**
* **🧠 ذاكرة دلالية مستمرة:** مبنية على [Prism MCP](https://github.com/dcostenco/prism-mcp).
* **🏥 تحويل التخصص الفوري.**
* **🎙️ إدخال محيطي بدون نقر:** باستخدام **WASM Whisper** في المتصفح.
* **⚡ RBAC على مستوى المطالبة.**
...
### للرعاية الصحية والعيادات (تطبيق ويب)
