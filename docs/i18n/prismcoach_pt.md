...
*   **Pro — Prism 1.7B no dispositivo** — funciona via llama.cpp com aceleração Metal. Zero rede, totalmente privado. Quando a RAM livre é ≥ 1.600 MB, usa o Prism Coder 1.7B (no dispositivo, Metal); quando a RAM livre é de 450–799 MB, usa o SmolLM2-360M (185 MB, no dispositivo); o treino nunca falha, apenas degrada gradualmente. Responde a perguntas sobre o seu treino, sugere correções de forma, ajusta o volume do dia com base na prontidão.
...
*   **6 separadores Watch** — Painel (Bateria Corporal), Mapa Muscular, Registo de Treino, Watch IA Coach, Teste de Toque SNC, Definições.
*   **Watch IA Coach** — IA conversacional completa no pulso: as consultas são retransmitidas para o iPhone emparelhado via WatchConnectivity; o iPhone executa a cascata no dispositivo 1.7B → 360M → nuvem e transmite a resposta de volta; muda para um estado claro de "iPhone não acessível" quando a ligação falha.
...
| SmolLM2-360M no dispositivo (reserva com RAM baixa) | — | ✅ | ✅ |
| Watch IA Coach (retransmissão) | — | ✅ | ✅ |
