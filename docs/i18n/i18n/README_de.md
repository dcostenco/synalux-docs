...
> Synalux ist eine offene, modulare elektronische Gesundheitsakte, die ihre klinische Sprache, Datenmodelle und KI-Verhalten an jede medizinische Fachrichtung anpasst.
...
* **🛡️ KI-Sandbox — "Kliniker in der Schleife" :** Synalux ist die erste EHR, bei der die KI **Ihre Daten nicht ohne Ihre Unterschrift berühren kann**.
* **🔐 Zustandsloses RLS — Horizontale Skalierung ohne Sitzungsüberlastung.**
* **🧠 Persistentes semantisches Gedächtnis:** Aufgebaut auf [Prism MCP](https://github.com/dcostenco/prism-mcp).
* **🏥 Sofortige Fachrichtungstransformation.**
* **🎙️ Klickfreie Umgebungserfassung:** Mit **WASM Whisper** im Browser.
* **⚡ RBAC auf Prompt-Ebene.**
...
### Für Gesundheitswesen und Kliniken (Web-App)
...
### Für Kliniken, die 100% lokal wünschen
```bash
# 1. Install Ollama
brew install ollama
