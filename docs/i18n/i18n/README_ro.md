...
**Platforma EHR modulară — Nativă în IA, conformă HIPAA, agnostică de specialitate**

> Synalux este o platformă de Fișă Electronică de Sănătate deschisă și modulară care își adaptează limbajul clinic, modelele de date și comportamentul IA pentru orice specialitate medicală.
...
* **🛡️ Sandbox IA — "Clinicianul în buclă" :** Synalux este primul EHR unde IA **nu poate atinge datele dumneavoastră fără semnătura dumneavoastră**.
* **🔐 RLS fără stare — Scalare orizontală fără suprasarcină de sesiune.**
* **🧠 Memorie semantică persistentă:** Construit pe [Prism MCP](https://github.com/dcostenco/prism-mcp).
* **🏥 Transformare instantanee a specialității.**
* **🎙️ Captare ambientală fără clic:** Folosind **WASM Whisper** în browser.
* **⚡ RBAC la nivel de prompt.**
...
### Pentru sănătate și clinici (aplicație web)
...
### Pentru clinici care doresc 100% local
```bash
# 1. Install Ollama
brew install ollama
