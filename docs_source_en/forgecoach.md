...
*   **AI-generated programs** (Elite) — describe your goal and constraints; ForgeCoach generates a fully custom multi-week block using Prism 8B or Claude Sonnet.
...
*   **ForgeCoachCore** — shared Swift Package (SPM) containing all engines, models, and business logic. Consumed by the iOS app, Mac Catalyst app, and watchOS extension.
...
*   **Subscription check** — email posted via HTTPS to `api.forgecoach.app/subscription/check`. Email stored in Keychain with 24-hour TTL and 48-hour grace window.
...
Subscribe at [forgecoach.app/subscribe](https://forgecoach.app/subscribe) — Stripe-backed web checkout. No in-app purchase required.
